...
#let rx_style(
  ...
  let serif = ("RidiBatang", "Noto Serif KR", "Noto Serif CJK KR", "Noto Serif JP", "Noto Serif CJK JP")
  let sans = ("Pretendard", "Noto Sans KR", "Noto Sans CJK KR", "Noto Sans JP", "Noto Sans CJK JP")
