...
#directive[흐름도를 사용하면 어떤 프로그램이나 행동을 알기 쉽게 그림으로 설명할 수 있습니다. 흐름도를 이해해봅시다.]
...
#grid(
  ...
  inset: 10pt,
  align: center + horizon,
  figure(image("assets/images/flowchart-lamp.png", width: 55mm), caption: [램프가 고장났을 때 흐름도]),
...
#directive[아래의 지문을 읽고 흐름도를 그려봅시다.]
...
#directive[지문의 글쓴이가 설명하고자 하는 내용은 무엇인가요? 도식으로 표현해봅시다.]
